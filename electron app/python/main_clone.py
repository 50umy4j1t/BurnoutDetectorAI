...
def generate_report(emotion_history, burnout_scores, session_start, heart_metrics=None):
    ...
    lines = []
    lines.append("=" * 55)
    lines.append("  Stresslens - SESSION REPORT")
...
def speak_text(text):
    """Audio playback is handled by the Electron frontend (kokoro-js)."""
    _ = text
    return
...
def save_report_and_get_support(emotion_history, burnout_scores, session_start):
    ...
    console.print("  " + "=" * 50 + "\n")
    console.print("  Frontend TTS will play this response in the dashboard.")
...
def main():
    console.print("=" * 55)
    console.print("  Stresslens AI System")
    ...
    while True:
        ...
        # Title
        cv2.putText(display, "Stresslens AI ", (w - sidebar_w + 10, 28),
        ...
        cv2.imshow("Stresslens AI - Burnout Predictor", display)
